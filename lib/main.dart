...
const request = "https://api.hgbrasil.com/finance?key=18f0263e";
...
Widget buildTextField(String label, String prefix, TextEditingController textEditingController, Function change, Function clear){
  return Padding(
